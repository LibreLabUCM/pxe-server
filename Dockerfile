...
LABEL maintainer "librelab@ucm.es"
...
RUN \
  ...
  && cp "$TEMP_SYSLINUX_PATH"/bios/com32/menu/vesamenu.c32 /var/lib/tftpboot/ \
  && cp "$TEMP_SYSLINUX_PATH"/bios/com32/lib/libcom32.c32 /var/lib/tftpboot/ \
